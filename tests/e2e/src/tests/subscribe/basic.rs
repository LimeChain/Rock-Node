...
/// Test Case: Finite historical range subscription.
/// Tests that a subscriber can request a specific range of already-persisted blocks.
#[tokio::test]
#[serial]
...
/// Test Case: Historical to live streaming transition.
/// Tests that a subscriber can seamlessly transition from reading persisted blocks
/// to waiting for new blocks to arrive.
#[tokio::test]
#[serial]
...
/// Tests that multiple independent subscribers can operate simultaneously
